...
frm.addEventListener("submit", (e) => {
    ...
    const parcela = (preco * 0.50) // ...e das parcelas

    resp1.innerText = `Promoção: ${veiculo}` // exibe as respostas
    resp2.innerText = `Entrada de R$ ${entrada.toFixed(2)}` // exibe as respostas
    resp3.innerText = `+12 de R$ ${parcela.toFixed(2)}` // exibe as respostas
